...
import { ArrowLeft, Package, Clock, ChefHat, Truck, CheckCircle2, Circle, XCircle, RefreshCw } from "lucide-react";
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {order.status !== "delivered" && order.status !== "cancelled" && estimatedTime && (
